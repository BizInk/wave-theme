...
$background_color = get_sub_field('background_color') ? get_sub_field('background_color') : '#333333';
...
else if($background_imagecolor == 'Video'){
    $background_html = '';
}
else{
    $background_html = 'style="background-color: '. $background_color .';"';
...
<section class="call-to-action-section <?php if($background_imagecolor == 'Video'): echo "call-to-action-section-video-bg"; endif; echo $general_class; ?>" <?= $background_html; ?>>
    ...
    if($background_imagecolor == 'Video'){
        if( $video_type == 'external' && !empty( $external_url ) ){ ?>
            <video autoplay muted loop playsinline class="bg-video">
                <source src="<?php echo esc_url( $external_url ); ?>" type="video/mp4">
            </video>
        <?php } elseif( $video_type == 'upload' && !empty( $video_file ) ){ ?>
